...
elseif(isset($_POST['suabaiviet'])){
    ...
    if(!empty($_FILES['hinhanh']['name'])){
        ...
        $sql_update = "UPDATE tbl_baiviet SET tenbaiviet='".$tenbaiviet."',
            hinhanh='".$hinhanh."',tomtat='".$tomtat."',noidung='".$noidung."',id_danhmuc='".$danhmuc."',tinhtrang='".$tinhtrang."'WHERE id='$_GET[idbaiviet]'";
        //xóa hình
        ...
        $sql_update = "UPDATE tbl_baiviet SET tenbaiviet='".$tenbaiviet."',
           tomtat='".$tomtat."',noidung='".$noidung."',id_danhmuc='".$danhmuc."',tinhtrang='".$tinhtrang."'WHERE id='$_GET[idbaiviet]'";
    }
