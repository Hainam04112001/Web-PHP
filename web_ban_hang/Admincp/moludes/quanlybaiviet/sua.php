...
<body>
  ...
  ?>
  <form method="POST" action ="moludes/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id']?>" enctype="multipart/form-data">
    <tr>
      <td>Tên bài viết</td>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="moludes/quanlybaiviet/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
      </td>
    </tr>
    <tr>
      <td>Tóm tắt</td>
      ...
      <td>
        <select name="danhmuc">
          ...
          while($row_danhmuc = mysqli_fetch_array($query_danhmuc)){
            if($row_danhmuc['id_baiviet']==$row['in_danhmuc']){
          ?>
