  ...
  <div class="arrow-steps clearfix">
    ...
    <?php
        if(isset($_POST['themvanchuyen'])){
            ...
            $sql_them_vanchuyen = mysqli_query($mysqli,"INSERT INTO tbl_shipping(name,phone,address,note,id_dangki) VALUES('$name','$phone','$address','$note','$id_dangki')");
            ...
            $note = $_POST['note'];
            $id_dangki = $_SESSION['id_khachhang'];
            $sql_update_vanchuyen = mysqli_query($mysqli,"UPDATE tbl_shipping SET name='$name',phone='$phone',address='$address',note='$note',id_dangki='$id_dangki'WHERE id_dangki ='$id_dangki'");
