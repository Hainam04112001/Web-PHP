...
<h4>Danh mục bài viết: <span style="text-align:center; text-transform: uppercase;"> <?php echo $row_title['tendanhmuc_baiviet'] ?></span></h4>
                <div class="row">
                    <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <a href="index.php?quanly=baiviet&id=<?php echo $row_bv['id']?>">
                            <img class="img img-responsive" width="100%" src='Admincp/moludes/quanlybaiviet/uploads/<?php echo $row_bv['hinhanh'] ?>'>
