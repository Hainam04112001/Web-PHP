...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning">
  <div class="container-fluid"> 
    <a class="navbar-brand"><img src="Admincp/Images/logo.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <!-- <li class="nav-item"><a class="nav-link" href="index.php?quanly=xemdonhang">Xem đơn hàng</a></li> -->
        ...
        <li class="nav-item dropdown">
          ...
          <?php
                ...
                ?>
            <li><a class="dropdown-item" href="index.php?quanly=danhmucsanpham&id=<?php echo $row_danhmuc['in_danhmuc']?>"><?php echo $row_danhmuc['tendanhmuc']?></a></li>   
            <?php
                }
                ?>
          </ul>
...
<!-- <div class="menu">
  <ul class = "list_menu">
      ...
      while($row_danhmuc = mysqli_fetch_array($query_danhmuc)){
      ?>
      <li><a href="index.php?quanly=danhmucsanpham&id=<?php echo $row_danhmuc['in_danhmuc']?>">
